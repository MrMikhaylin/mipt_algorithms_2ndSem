...
def plot_iterations_vs_time(file1, file2, file3, file4):
    ...
    plt.plot(*zip(*data4), color='orange', label=file4)
...
# Создаем первый, второй, третий, четвертый графики и их объединение
plot_iterations_vs_time('Bubble', 'Insertion', 'Selection', 'Shell')