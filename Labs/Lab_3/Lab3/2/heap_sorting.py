...
def plot_iterations_vs_time(file1, file2, file3, file4, file5):
    ...
    plt.plot(*zip(*data3), color='cyan', label=file3)
    plt.plot(*zip(*data4), color='green', label=file4)
    plt.plot(*zip(*data5), color='purple', label=file5)
...
plot_iterations_vs_time('Heap_2', 'Heap_3', 'Heap_4', 'Heap_5', 'Heap_6')